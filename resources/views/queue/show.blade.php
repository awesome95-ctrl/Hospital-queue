<x-app-layout>
    <div class="max-w-4xl mx-auto py-10 px-6">
        <div class="bg-white rounded-xl shadow p-8">
            ...
            @if(session('success'))
                <div class="mt-6 rounded-xl bg-green-50 border border-green-200 p-4 text-green-700">
                    {{ session('success') }}
                </div>
            @endif
            ...
            <div class="mt-8 grid gap-6 lg:grid-cols-2">
                <div class="space-y-4 rounded-xl bg-slate-50 p-6">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-semibold">{{ $queue->queue_number }}</p>
                    </div>
                    <div>
                ...
                <div class="space-y-4 rounded-xl bg-slate-50 p-6">
                    <div>
                        ...
                        <p class="text-xl font-semibold">{{ $patientsAhead }}</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-500">Estimated Waiting Time</p>
                        <p class="text-xl font-semibold">{{ $estimatedWait }} minutes</p>
                    </div>
                    <div>
            ...
            <div class="mt-8 rounded-xl border border-gray-200 bg-white p-6">
                ...
                <dl class="mt-4 grid gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <dd class="mt-1 text-gray-900 capitalize">{{ $queue->status }}</dd>
                    </div>
                    <div>
